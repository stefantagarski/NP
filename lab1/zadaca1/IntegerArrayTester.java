...
final class IntegerArray {
    ...
    public IntegerArray concat(IntegerArray array2) {
        ...
        System.arraycopy(array2.array, 0, array3, length(), array2.length());
        return new IntegerArray(array3);
    }
    ...
    public double average() {
        return Arrays.stream(array).average().isPresent() ? Arrays.stream(array).average().getAsDouble() : 0;
    }
    ...
    public String toString() {
        ...
        stringBuilder.append(array[length() -1]).append("]");
